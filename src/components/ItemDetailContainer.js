...
const productList = [
    ...
    {id: "1005", title: "Bateria Salicru 7Ah/12V PARA SAI UBT 12/7", price: "1800", pictureUrl: "https://www.quonty.com/img2/maxi/a/qtya0002565_00.jpg", category: "componentes", stock: "10"},
...
const ItemDetailContainer = () => {
    ...
    useEffect(() => {
        ...
        /*
        const query = firestore.collection("productos").doc(params.id)
